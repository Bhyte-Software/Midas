...
public class PlatformsAdapterVertical extends RecyclerView.Adapter<PlatformsAdapterVertical.PlatformsViewHolder> {

    ArrayList<PlatformsHelperClass> platforms;

    public PlatformsAdapterVertical(ArrayList<PlatformsHelperClass> platforms) {
    ...
    public PlatformsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.platforms_layout_vertical, parent, false);
